  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: SingleChildScrollView(
        padding: EdgeInsets.symmetric(horizontal: size.width * .05, vertical: 16),
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Hello Jatin!", style: AppTextStyles.heading),
                ...
                SvgPicture.asset("assets/dashboard/hand.svg", height: 80),
              ],
            ),
                ...
                children: [
                  const Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text("Nearest accepted lead- 2.1 km away",
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: const [
                Text("Today’s Visits", style: AppTextStyles.sectionTitle),
                Row(
                  children: [
            ...
            const Row(
              children: [
                _QuickAction("Add Expenses", "assets/dashboard/add.svg"),
                _QuickAction("Inspection\nGuidelines",
                    "assets/dashboard/inspection.svg"),
                _QuickAction("Call Supervisor", "assets/dashboard/call.svg"),
              ],
            ),
