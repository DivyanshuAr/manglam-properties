...
import '../in_progress_details_screen.dart';

class InProgressLeadsTab extends StatelessWidget {
  const InProgressLeadsTab({super.key});
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => const InProgressDetailsScreen(),
              ),
            );
          },
          child: AppCard(
              ...
              children: [
                ...
                Row(
                  ...
                  children: const [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Started at", style: AppTextStyles.label),
                        Text("2hrs 15m ago", style: AppTextStyles.value),
                      ],
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Text("45 min", style: AppTextStyles.value),
                      ],
                    ),
                  ],
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {},
                    child: const Text("Continue Filling Form"),
                  ),
                ),
